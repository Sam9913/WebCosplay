    ...
    public partial class Customer_Profile : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Request.Cookies["customerName"] != null)
            {
                ...
                string getUserID = "SELECT CU.Cust_ID FROM Customer CU WHERE CU.Cust_Username = '" + username + "'";
        ...
        protected void LinkButton3_Command(object sender, CommandEventArgs e)
        {
            ...
            string deleteConfirm = hdn_confirmDelete.Value;
            string galleryID = (Repeater3.Items[index].FindControl("hidden_Gallery_ID") as HiddenField).Value;
            int status = 0;
            ...
            {
                SqlDataAdapter adapter = new SqlDataAdapter();
                string str = "UPDATE Gallery set Gallery_Status = '" + status + "' WHERE Gallery_ID = '" + galleryID + "'";
                ...
                Repeater3.DataBind();
                Response.Redirect("Customer_Profile.aspx", false);
            }
        }
        ...
        protected void editProfile_Click(object sender, EventArgs e)
        {
            ...
            string str = "SELECT * FROM Customer WHERE Cust_ID = '" + login_userID + "'";
            SqlCommand getCustData = new SqlCommand(str, con);


            con.Open();
            SqlDataReader dr = getCustData.ExecuteReader();
            while (dr.Read())
            {
                editProf_name.Text = dr["Cust_Name"].ToString();
                editProf_phone.Text = dr["Cust_Phone"].ToString();
                editProf_email.Text = dr["Cust_Email"].ToString();
                editProf_ic.Text = dr["Cust_IC"].ToString();
                editProf_gender.Text = dr["Cust_Gender"].ToString();
                editProf_desc.Value = dr["Cust_Details"].ToString();
                editProf_oriImage.Src = "~/image/" + dr["Cust_Image"].ToString();
            }
        }
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            ...
            {
                imageName = editProf_oriImage.Src;
                imageName = imageName.Remove(0, 8);
            }

            SqlDataAdapter adapter = new SqlDataAdapter();
            string str = "UPDATE Customer set Cust_Name = '" + editProf_name.Text + "', Cust_IC = '" + editProf_ic.Text + 
                "', Cust_Phone = '" + editProf_phone.Text + "', Cust_Email = '" +  editProf_email.Text + "', Cust_Gender = '" + 
                editProf_gender.Text + "', Cust_Details = '" + editProf_desc.Value + "', Cust_Image = '" + imageName + "'";
