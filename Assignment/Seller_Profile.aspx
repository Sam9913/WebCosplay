...
<asp:Content ContentPlaceHolderID="ContentPlaceHolder1" ID="Content1" runat="server">
    ...
    <%--<link rel="stylesheet" href="https://www.w3schools.com/w3css/4/w3.css"> --%><!--comment this to let the screen unscrollable-->
...
<%--            <div class="background_image" style="text-align:center; height: 300px;" >
            ...
            <asp:Repeater ID="Repeater1" runat="server" DataSourceID="SqlDataSource1">
                <ItemTemplate>
                    ...
                    <div style="text-align:center; margin-top: 2%;" >
                        ...
                        <asp:Label ID="Seller_NameLabel" runat="server" CssClass="username usernameBold" Text='<%# Eval("Seller_Name") %>' ></asp:Label>
                    </div>
                        ...
                        <ItemTemplate>
                            ...
                            <div style="width: 100%; float:left; min-width: 850px; margin-top: 7%; height: auto; border:2px solid #eee; box-shadow:  0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">
                                ...
                                <div style="margin: 2%; float:left; width: 5%; min-width: 42px; text-align:center;">
                                    ...
                                    <%--<div style="">233</div>--%>
                                    <asp:Label ID="numLikes" runat="server" Text='<%# Eval("TotalLikes") %>'></asp:Label><br />
                                    ...
                                    <asp:LinkButton ID="LinkButton2" CssClass="far fa-comment icon_comment" runat="server" ToolTip="Comment" CommandArgument='<%# Container.ItemIndex%>' OnCommand="LinkButton2_Command" OnClientClick="visible();">
                                    </asp:LinkButton>
    ...
    <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString='<%$ ConnectionStrings:ConnectionString %>' SelectCommand="SELECT G.Gallery_ID, G.Gallery_Image, G.Gallery_Desc, G.Gallery_Date, G.Gallery_Tag, G.Gallery_Status, G.User_ID, G.TotalLikes, S.Seller_UserName FROM Gallery AS G INNER JOIN Seller AS S ON G.User_ID = S.Seller_ID WHERE (S.Seller_UserName = @SellerName) AND (G.Gallery_Status = 1) ORDER BY G.Gallery_Date DESC">
        <SelectParameters>
            <asp:CookieParameter CookieName="sellerName" Name="SellerName"></asp:CookieParameter>
