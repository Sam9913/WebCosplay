    ...
    public partial class Register : System.Web.UI.Page
    {
        ...
        protected void btnCreate_Click(object sender, EventArgs e)
        {
            ...
            if (FileUpload1.HasFile)
            {
                ...
                {
                    string insertCustQuery = "INSERT into Customer (Cust_ID, Cust_Name, Cust_IC, Cust_Gender, Cust_Phone, Cust_Email, Cust_UserName, Cust_Pass, Cust_Image, Cust_Details, Cust_Address) " +
                        "values (@id, @name, @ic, @gender, @phone, @email, @username, @password, @image, @details, @address)";
                ...
                else if(rbnAccType.SelectedIndex == 1)
                {
                    ...
                    cmd2.Parameters.AddWithValue("@details", txtDetail.Text);
